...
d3.json("mn.geojson").then(function (data) {
    ...
    svg.selectAll(".m")
        ...
        .on("click", function (d) {
            ...
            const [markerX, markerY] = projection([d.srcElement.__data__.long, d.srcElement.__data__.lat]);
            ...
            popover.select(".popover-content").html(`<div class='w-full h-full relative p-4 flex flex-row items-start gap-4'>
